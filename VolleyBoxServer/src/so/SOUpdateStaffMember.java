...
public class SOUpdateStaffMember extends SOClass {
    ...
    public SOUpdateStaffMember(ObjectOutputStream out) {
        super(out);
    }
    ...
    public void execute(Object object) throws IOException {
        try {
            ...
            DBBroker.getInstance().updateStaffMember(staff);
            out.writeObject(new Response(ServerResponse.OK, null));
        } catch (SQLException ex) {
            out.writeObject(new Response(ServerResponse.ERROR, "Cannot update staff member"));
        }
    }
