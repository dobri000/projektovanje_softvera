...
public class SOAddStaffMemberEngagement extends SOClass {
    ...
    public SOAddStaffMemberEngagement(ObjectOutputStream out) {
        super(out);
    }
    ...
    public void execute(Object object) throws IOException {
        try {
            ...
            out.writeObject(new Response(ServerResponse.ERROR, "Staff member engagement not successfully added"));
        }
    }
