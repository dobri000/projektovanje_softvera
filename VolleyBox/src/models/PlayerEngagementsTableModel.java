 ...
 * @author HOME
 */
public class PlayerEngagementsTableModel extends AbstractTableModel {
    
    private List<PlayerEngagement> engagements;

    public PlayerEngagementsTableModel(List<PlayerEngagement> engagements) {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        PlayerEngagement engagement = engagements.get(rowIndex);
        switch(columnIndex){
            case 0:
